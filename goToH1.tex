В системе уравнений \eqref{hFirstSystemOfEquationsFirst} и уравнение \eqref{hFirstSystemOfEquationsSecond} сделаем замену 
\begin{align*}
...
\begin{equation}
	...
	\end{split}
\end{equation}
С учетом \eqref{a_func} перепишем систему \eqref{renameH1}
