...
В результате выполнения программы [17] получим, что левая часть уравнения так же равна 0, при подстановки решения \eqref{R}, во всех случаях, кроме $n_{1}=0, n_{2}=N$.
